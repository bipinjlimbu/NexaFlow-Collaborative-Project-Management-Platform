export default function Loading() {
    return (
        <main className="min-h-screen bg-slate-950 text-slate-50 flex items-center justify-center px-6 py-12">
            <div className="w-full max-w-md space-y-5 rounded-2xl border border-slate-800/80 bg-slate-900/50 p-8 shadow-xl backdrop-blur-sm animate-pulse">
                <div className="space-y-2">
                    <div className="flex items-center gap-3">
                        <div className="h-8 w-8 rounded-xl bg-slate-800" />
                        <div className="h-5 w-24 rounded-md bg-slate-800" />
                    </div>
                    <div className="h-7 w-32 rounded-md bg-slate-800 mt-2" />
                ...
                <div className="h-4 w-40 mx-auto rounded-md bg-slate-800/60" />
            </div>
        </main>
    );
}