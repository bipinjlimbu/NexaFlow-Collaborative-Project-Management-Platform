            ...
            <main className="max-w-7xl mx-auto px-6 py-12 w-full flex-1 space-y-10">
                <section className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-800">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-xs font-mono text-slate-500">TechNova Ecosystem</span>
                        </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button className="border border-slate-800 hover:border-slate-700 bg-slate-900/60 text-slate-300 hover:text-white font-medium px-4 py-2.5 rounded-xl transition-all text-sm">
                            + New Workspace
                        </button>
                        <button className="bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-5 py-2.5 rounded-xl transition-all shadow-lg shadow-indigo-600/25 text-sm active:scale-95">
                            + Create Project
                        </button>
                    </div>
                </section>
                ...
                <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80">
                        <span className="text-xs font-mono text-slate-500 uppercase tracking-wider">Active Workspaces</span>
                        <div className="mt-2 flex items-baseline justify-between">
                            <span className="text-3xl font-extrabold text-white">04</span>
                            <span className="text-xs font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">OWNER</span>
                        </div>
                    </div>

                    <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80">
                        <span className="text-xs font-mono text-slate-500 uppercase tracking-wider">Total Projects</span>
                        <div className="mt-2 flex items-baseline justify-between">
                            <span className="text-3xl font-extrabold text-white">12</span>
                            <span className="text-xs font-mono text-indigo-400 bg-indigo-500/10 px-2 py-0.5 rounded border border-indigo-500/20">8 Active</span>
                        </div>
                    </div>

                    <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80">
                        <span className="text-xs font-mono text-slate-500 uppercase tracking-wider">Pending Tasks</span>
                        <div className="mt-2 flex items-baseline justify-between">
                            <span className="text-3xl font-extrabold text-white">19</span>
                            <span className="text-xs font-mono text-amber-400 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/20">In Progress</span>
                        </div>
                    </div>

                    <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80">
                        <span className="text-xs font-mono text-slate-500 uppercase tracking-wider">Overall Completion</span>
                        <div className="mt-2 flex items-baseline justify-between">
                            <span className="text-3xl font-extrabold text-white">74%</span>
                            <span className="text-xs font-mono text-sky-400">+12% this wk</span>
                        </div>
                    </div>
                </section>
                ...
                <section className="grid lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-5">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/projects" className="text-xs font-mono text-indigo-400 hover:underline">
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div>
                                                <div className="flex items-center gap-2">
                                                    <span className="text-xs font-mono text-indigo-400 font-bold">{project.workspace}</span>
                                                    <span className="text-slate-600">•</span>
                                                    <span className="text-xs text-slate-400">{project.status}</span>
                                                </div>
                                                <h3 className="text-base font-bold text-slate-100 mt-1">{project.name}</h3>
                                            </div>
                    ...
                    <div className="space-y-5">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-mono text-slate-500">Real-time Sync</span>
                        </div>
                        ...
                        <div className="p-1 bg-gradient-to-b from-slate-800 to-slate-900/40 rounded-2xl border border-slate-800 shadow-2xl">
                            <div className="bg-slate-950 p-5 rounded-[14px] font-mono text-xs space-y-4">
                                <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
                                    ...
                                    <span className="text-[10px] text-slate-500">NexaFlow Terminal</span>
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="pl-4 border-l border-slate-800 space-y-2.5">
                                        <div className="text-slate-300 font-semibold">CMS Engine</div>
                                        <div className="pl-3 space-y-1 text-[11px]">
                                            <div className="text-emerald-400">✓ Login system deployed</div>
                                            <div className="text-amber-400">&gt; Student module compiling</div>
                                            <div className="text-slate-500">o Attendance queue open</div>
                                        </div>
                                    </div>
                ...
                <section className="space-y-5">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/tasks" className="text-xs font-mono text-indigo-400 hover:underline">
                            Open Tasks &rarr;
                        </Link>
                    </div>
                            ...
                            {recentTasks.map((task) => (
                                <div key={task.id} className="py-3.5 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                    <div className="space-y-1">
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs font-mono text-indigo-400">{task.workspace}</span>
                                            <span className="text-slate-600">•</span>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <span className="text-xs font-mono text-slate-500">Due: {task.dueDate}</span>
                                        {task.status === "DONE" && (
